      ...
      <div className="container px-5 py-4 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
            <div className="skeleton h-64 w-full rounded bg-gray-200"></div>
          ...
          <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
            <h2 className="skeleton text-sm title-font text-gray-500 tracking-widest bg-gray-200 h-4 mb-2 p-5"></h2>
            <h1 className="skeleton text-3xl title-font font-medium mb-4 bg-gray-200 h-8"></h1>
            ...
            <div className="skeleton leading-relaxed mb-4 bg-gray-200 h-20"></div>
            ...
            <div className="flex items-center justify-between mt-4">
              <span className="skeleton w-24 h-8 bg-gray-200"></span>
